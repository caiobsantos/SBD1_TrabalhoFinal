...
-- Autor(es) ..............: Caio Santos e Débora Caires de Souza Moreira
...
CREATE TABLE LEAD (
    ...
    CONSTRAINT FK_LEAD_1 FOREIGN KEY (telefone_PK)
    REFERENCES TELEFONE (telefone_PK),
    CONSTRAINT FK_LEAD_2 FOREIGN KEY (idTipoOrigem)
...
CREATE TABLE CLIENTE (
    ...
    CONSTRAINT FK_CLIENTE_2 FOREIGN KEY (idLead)
...
CREATE TABLE VENDEDOR (
    ...
    PRIMARY KEY (idVendedor, idFuncionario),
...
CREATE TABLE VENDA (
    ...
    CONSTRAINT FK_VENDA_1 FOREIGN KEY (idVendedor, idFuncionario)
    REFERENCES VENDEDOR (idVendedor, idFuncionario)
    ON DELETE CASCADE,
...
CREATE TABLE PESSOAFISICA (
    ...
    CONSTRAINT FK_PESSOAFISICA_1 FOREIGN KEY (Cliente)
    REFERENCES CLIENTE (idCliente)
    ON DELETE CASCADE;
)Engine = InnoDB;
...
CREATE TABLE CATEGORIAPRODUTO (
    idCategoriaProduto INTEGER NOT NULL AUTO_INCREMENT,
    nome CHAR(25) NOT NULL,
...
CREATE TABLE FORNECEDOR (
    ...
    REFERENCES idCategoriaProduto (idCategoriaProduto_PK)
    ON DELETE NO ACTION;
) Engine = InnoDB;

CREATE TABLE PRODUTOSCOMPRADOS (
    idProdutosComprados INTEGER NOT NULL AUTO_INCREMENT,
    ...
    CONSTRAINT PRODUTOSVENDIDOS_LOJA_FK FOREIGN KEY (idLoja) REFERENCES LOJA (idLoja) ON DELETE RESTRICT,
    CONSTRAINT PRODUTOSPVENDIDOS_PRODUTO_FK FOREIGN KEY (idProduto) REFERENCES PRODUTO (idProduto) ON DELETE RESTRICT,
    CONSTRAINT PRODUTOSPVENDIDOS_FORNECEDOR_FK FOREIGN KEY (idFornecedor) REFERENCES FORNECEDOR (idFornecedor) ON DELETE RESTRICT
)Engine = InnoDB;

CREATE TABLE PRODUTOSVENDIDOS (
    idProdutosVendidos INTEGER NOT NULL AUTO_INCREMENT,
    quantidade INTEGER NOT NULL CHECK (quantidade > 0),
    idEstoque INTEGER NOT NULL,
    idProduto INTEGER NOT NULL,
...
CREATE TABLE HISTORICOCLIENTE (
    ...
    idCliente INTEGER,
    idLead INTEGER,
    descricaoAtendimento CHAR(500) NOT NULL,
    idVendedor INTEGER NOT NULL,
    ...
    REFERENCES CLIENTE (idCliente),
    CONSTRAINT FK_HISTORICOCLIENTE_2 FOREIGN KEY (idLead)
    REFERENCES LEAD (idLead),
...
CREATE TABLE TIPOORIGEM (
    idTipoOrigem INTEGER NOT NULL AUTO_INCREMENT,
    nome CHAR(25) NOT NULL,
...
CREATE TABLE TERCEIRIZADO (
    idTerceirizado INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE CATEGORIATERCEIRIZADO (
    idCategoriaTerceirizado INTEGER NOT NULL AUTO_INCREMENT,
    nome CHAR(25) NOT NULL,
...
CREATE TABLE CATEGORIAPRODUTOFORNECEDOR (
    idCategoriaProdutoFornecedor INTEGER NOT NULL AUTO_INCREMENT,
    idCategoriaProduto INTEGER NOT NULL,
    idFornecedor INTEGER NOT NULL,

    CONSTRAINT CATEGORIAPRODUTOFORNECEDOR_PK PRIMARY KEY (idContrata),
    ...
    CONSTRAINT CATEGORIAPRODUTOFORNECEDOR_FORNECEDOR_FK FOREIGN KEY (idFornecedor) REFERENCES FORNECEDOR (idFornecedor) ON DELETE RESTRICT,
)Engine = InnoDB;
...
CREATE TABLE CONTRATA (
    idContrata INTEGER NOT NULL AUTO_INCREMENT,
    idLoja INTEGER NOT NULL,
    idTerceirizado INTEGER NOT NULL,
    descricaoServico CHAR(500) NOT NULL,
    ...
    CONSTRAINT CONTRATA_TERCEIRIZADO_FK FOREIGN KEY (idTerceirizad) REFERENCES TERCEIRIZADO (idTerceirizado) ON DELETE RESTRICT
)Engine = InnoDB;